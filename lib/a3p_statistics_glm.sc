...
/** \cond */
module a3p_statistics_glm;

import a3p_matrix;
import a3p_oblivious;
import a3p_statistics_common;
import a3p_statistics_regression;
import additive3pp;
import matrix;
import oblivious;
import stdlib;
...
/**
 * @file
 * \defgroup a3p_statistics_glm a3p_statistics_glm.sc
 * \defgroup a3p_glm_constants constants
 * \defgroup a3p_generalized_linear_model generalizedLinearModel
 * \defgroup a3p_generalized_linear_model_method generalizedLinearModel(with method parameter)
 */

/**
 * \addtogroup <a3p_statistics_glm>
 * @{
...
/**
 * \addtogroup <a3p_generalized_linear_model>
 * @{
...
/**
 * \addtogroup <a3p_generalized_linear_model_method>
 * @{
 * @brief Fitting of generalized linear models
 * @note **D** - additive3pp protection domain
 * @note Supported types - \ref int32 "int32" \ /ref int64 "int64" \
