 ...
 *  @{
 *  @brief Open connection to a data source. Multiple connections can not be open simultaneously. Before opening a new connection the old one should be closed.
