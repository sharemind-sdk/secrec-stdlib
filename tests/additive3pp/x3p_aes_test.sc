...
void main(){
    ...
    print("TEST 3: Encrypt with aes128");
    {
        ...
        pd_a3p xor_uint32[[1]] cipherText1 = {0x3925841d, 0x2dc09fb, 0xdc118597, 0x196a0b32};
        ...
        pd_a3p xor_uint32[[1]] cipherText2 = aes128EncryptEcb(expandedKey,plainText);
    ...
    {
        pd_a3p xor_uint32[[1]] plainText = {0x681c7acc, 0x1cdfa764, 0x8625d98c, 0xe535075a};
        pd_a3p xor_uint32[[1]] cipherText1 = {0xf58ba066, 0x2b2a7bcc, 0xf48583fa, 0xa27bd0e4};
        pd_a3p xor_uint32[[1]] expandedKey = {
        ...
        pd_a3p xor_uint32[[1]] cipherText2 = aes192EncryptEcb(expandedKey,plainText);
        if(all(declassify(cipherText1) == declassify(cipherText2))){
            succeeded_tests = succeeded_tests + 1;
            all_tests = all_tests +1;
            print("SUCCESS!");
    ...
    {
        pd_a3p xor_uint32[[1]] plainText = {0x6d7134dd, 0x13026986, 0xa43e0ada, 0x569c6b53};
        pd_a3p xor_uint32[[1]] cipherText1 = {0x91e3fd7c, 0x3221ec20, 0x64d8b896, 0xa0ccecab};
        pd_a3p xor_uint32[[1]] expandedKey = {
        ...
        pd_a3p xor_uint32[[1]] cipherText2 = aes256EncryptEcb(expandedKey,plainText);
        if(all(declassify(cipherText1) == declassify(cipherText2))){
            succeeded_tests = succeeded_tests + 1;
            all_tests = all_tests +1;
            print("SUCCESS!");
