...
void main(){
	...
	public int64 INT64_MIN = -9223372036854775808;
 	...
 	{
 		print("xor_uint8");
 		pd_shared3p xor_uint8 priv = 0;
 		public uint8 pub = 0;
 		xor_test(priv,pub);
 	}
 	{
 		print("xor_uint16");
 		pd_shared3p xor_uint16 priv = 0;
 		public uint16 pub = 0;
 		xor_test(priv,pub);
 	}
 	{
 		print("xor_uint32");
 		pd_shared3p xor_uint32 priv = 0;
 		public uint32 pub = 0;
 		xor_test(priv,pub);
 	}
 	{
 		print("xor_uint64");
 		pd_shared3p xor_uint64 priv = 0;
 		public uint64 pub = 0;
 		xor_test(priv,pub);
 	}
    ...
    {
 		print("xor_uint8");
 		pd_shared3p xor_uint8 priv = 1;
 		public uint8 pub = 1;
 		xor_test(priv,pub);
 	}
 	{
 		print("xor_uint16");
 		pd_shared3p xor_uint16 priv = 1;
 		public uint16 pub = 1;
 		xor_test(priv,pub);
 	}
 	{
 		print("xor_uint32");
 		pd_shared3p xor_uint32 priv = 1;
 		public uint32 pub = 1;
 		xor_test(priv,pub);
 	}
 	{
 		print("xor_uint64");
 		pd_shared3p xor_uint64 priv = 1;
 		public uint64 pub = 1;
 		xor_test(priv,pub);
 	}
    ...
    }
    {
 	...
 	{
 		print("xor_uint8");
 		pd_shared3p xor_uint8 priv = UINT8_MAX-1;
 		public uint8 pub = UINT8_MAX-1;
 		xor_test(priv,pub);
 	}
 	{
 		print("xor_uint16");
 		pd_shared3p xor_uint16 priv = UINT16_MAX-1;
 		public uint16 pub = UINT16_MAX-1;
 		xor_test(priv,pub);
 	}
 	{
 		print("xor_uint32");
 		pd_shared3p xor_uint32 priv = UINT32_MAX-1;
 		public uint32 pub = UINT32_MAX-1;
 		xor_test(priv,pub);
 	}
 	{
 		print("xor_uint64");
 		pd_shared3p xor_uint64 priv = UINT64_MAX-1;
 	...
 	{
 		print("xor_uint8");
 		pd_shared3p xor_uint8 priv = UINT8_MAX;
 		public uint8 pub = UINT8_MAX;
 		xor_test(priv,pub);
 	}
 	{
 		print("xor_uint16");
 		pd_shared3p xor_uint16 priv = UINT16_MAX;
 		public uint16 pub = UINT16_MAX;
 		xor_test(priv,pub);
 	}
 	{
 		print("xor_uint32");
 		pd_shared3p xor_uint32 priv = UINT32_MAX;
 		public uint32 pub = UINT32_MAX;
 		xor_test(priv,pub);
 	}
 	{
 		print("xor_uint64");
 		pd_shared3p xor_uint64 priv = UINT64_MAX;
