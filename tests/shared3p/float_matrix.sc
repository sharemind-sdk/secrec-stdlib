...
//---------------------------------------------
// shared3p_matrix templates
//---------------------------------------------
template<type T>
void shared3p_row_sum_test(T data){
	{
		pd_shared3p T[[2]] mat2 (3,0);
		pd_shared3p T[[1]] result = rowSums(mat2);
	}
	pd_shared3p T[[2]] mat (3,3);
	T[[1]] control (3);
	mat = random(mat);
...
template<type T>
void shared3p_dot_product(T data){
	{
		pd_shared3p T[[1]] vec (0);
		pd_shared3p T[[1]] vec2 (0);
...
template<type T>
void shared3p_dot_product_matrix(T data){
	{
		pd_shared3p T[[2]] mat (3,0);
		pd_shared3p T[[2]] mat2 (3,0);
		pd_shared3p T[[1]] result = dotProduct(mat,mat2);
	}
	pd_shared3p T[[2]] mat (3,3);
	pd_shared3p T[[2]] mat2 (3,3);
	mat = random(mat); mat2 = random(mat2);
...
template<type T>
void shared3p_cross_product(T data){
	{
		pd_shared3p T[[2]] mat (0,3);
		pd_shared3p T[[2]] mat2 (0,3);
		pd_shared3p T[[2]] result = crossProduct(mat,mat2);
	}
	pd_shared3p T[[1]] vec (3);
	pd_shared3p T[[1]] vec2 (3);
	vec = random(vec); vec2 = random(vec2);
...
template<type T>
void shared3p_cross_product_matrix(T data){
	{
		pd_shared3p T[[2]] mat (3,0);
		pd_shared3p T[[2]] mat2 (0,3);
		pd_shared3p T[[2]] result = matrixMultiplication(mat,mat2);
	}
	pd_shared3p T[[2]] mat (3,3);
	pd_shared3p T[[2]] mat2 (3,3);
	mat = random(mat); mat2 = random(mat2);
...
template<type T>
void shared3p_mat_multiplication(T data){
	{
		pd_shared3p T[[2]] mat (0,0);
		pd_shared3p T[[2]] mat2 (0,0);
		pd_shared3p T[[2]] result = diagMatrixMultiplication(mat,mat2);
		pd_shared3p T[[2]] mat3 (3,0);
		pd_shared3p T[[2]] mat4 (0,0);
...
template<type T>
void shared3p_diag_mat_multiplication(T data){
	{
		pd_shared3p T[[2]] mat (0,0);
		pd_shared3p T[[2]] mat2 (0,0);
		pd_shared3p T[[2]] result = diagMatrixMultiplication(mat,mat2);
...
template<type T>
void shared3p_mat3D_multiplication(T data){
	pd_shared3p T[[3]] mat (2,2,2);
...
template<type T>
void shared3p_diag3D_mat_multiplication(T data){
	{
		pd_shared3p T[[3]] mat (0,0,0);
		pd_shared3p T[[3]] mat2 (0,0,0);
		pd_shared3p T[[3]] result = diagMatrixMultiplication(mat,mat2);
		pd_shared3p T[[3]] mat3 (3,0,0);
		pd_shared3p T[[3]] mat4 (3,0,0);
		result = diagMatrixMultiplication(mat3,mat4);
		pd_shared3p T[[3]] mat5 (0,0,3);
		pd_shared3p T[[3]] mat6 (0,3,3);
...
template<type T>
void shared3p_vec_length(T data){
	{
		pd_shared3p T[[1]] vec (0);
		pd_shared3p T length = vecLength(vec);
	}
	pd_shared3p T[[1]] vec (3);
	vec = random(vec);
...
template<type T>
void shared3p_unit_vec(T data){
//	{
//		pd_shared3p T[[1]] vec (0);
//		pd_shared3p T[[1]] unit_vector = unitVector(vec);
//	}
	pd_shared3p T[[1]] vec (3);
	vec = random(vec);
	T[[1]] vec2 = declassify(vec);
...
template<type T>
void shared3p_vec_length2D(T data){
	{
//		pd_shared3p T[[2]] vec (0,0);
//		pd_shared3p T[[1]] length = vecLength(vec);
		pd_shared3p T[[2]] vec2 (2,0);
		pd_shared3p T[[1]] length = vecLength(vec2);
//		pd_shared3p T[[2]] vec3 (0,2);
...
template<type T>
void shared3p_unit_vec2D(T data){
//	{
//		pd_shared3p T[[2]] vec (0,0);
//		pd_shared3p T[[2]] unit_vector = unitVector(vec);
//		pd_shared3p T[[2]] vec2 (2,0);
//		pd_shared3p T[[2]] unit_vector = unitVector(vec2);
//		pd_shared3p T[[2]] vec3 (0,2);
...
void main(){
	...
	{
		print("float32");
		pd_shared3p float32 data = 0.0;
		test_transpose(data);
		test_transpose2(data);
	}
	{
		print("float64");
		pd_shared3p float64 data = 0.0;
		test_transpose(data);
		test_transpose2(data);
	}
	...
	print("TEST 8: shared3p Matrix row sums");
	{
		print("float32");
		shared3p_row_sum_test(0::float32);
	}
	{
		print("float64");
		shared3p_row_sum_test(0::float64);
	}
	print("TEST 9: shared3p Matrix dotproduct for vectors");
	{
		print("float32");
		shared3p_dot_product(0::float32);
	}
	{
		print("float64");
		shared3p_dot_product(0::float64);
	}
	print("TEST 10: shared3p Matrix dotproduct for matrices");
	{
		print("float32");
		shared3p_dot_product_matrix(0::float32);
	}
	{
		print("float64");
		shared3p_dot_product_matrix(0::float64);
	}
	print("TEST 11: shared3p cross product for vectors");
	{
		print("float32");
		shared3p_cross_product(0::float32);
	}
	{
		print("float64");
		shared3p_cross_product(0::float64);
	}
	print("TEST 12: shared3p cross product for matrices");
	{
		print("float32");
		shared3p_cross_product_matrix(0::float32);
	}
	{
		print("float64");
		shared3p_cross_product_matrix(0::float64);
	}
	print("TEST 13: shared3p 2D Matrix multiplication");
	{
		print("float32");
		shared3p_mat_multiplication(0::float32);
	}
	{
		print("float64");
		shared3p_mat_multiplication(0::float64);
	}
	print("TEST 14: shared3p 2D Diagonal matrix multiplication");
	{
		print("float32");
		shared3p_diag_mat_multiplication(0::float32);
	}
	{
		print("float64");
		shared3p_diag_mat_multiplication(0::float64);
	}
	print("TEST 15: shared3p 3D Matrix multiplication");
	{
		print("float32");
		shared3p_mat3D_multiplication(0::float32);
	}
	{
		print("float64");
		shared3p_mat3D_multiplication(0::float64);
	}
	print("TEST 16: shared3p 3D Diagonal matrix multiplication");
	{
		print("float32");
		shared3p_diag3D_mat_multiplication(0::float32);
	}
	{
		print("float64");
		shared3p_diag3D_mat_multiplication(0::float64);
	}
	print("TEST 17: shared3p vector length");
	{
		print("float32");
		shared3p_vec_length(0::float32);
	}
	{
		print("float64");
		shared3p_vec_length(0::float64);
	}
	print("TEST 18: shared3p unit vector");
	{
		print("float32");
		shared3p_unit_vec(0::float32);
	}
	{
		print("float64");
		shared3p_unit_vec(0::float64);
	}
	print("TEST 19: shared3p vector length 2D");
	{
		print("float32");
		shared3p_vec_length2D(0::float32);
	}
	{
		print("float64");
		shared3p_vec_length2D(0::float64);
	}
	print("TEST 20: shared3p unit vector 2D");
	{
		print("float32");
		shared3p_unit_vec2D(0::float32);
	}
	{
		print("float64");
		shared3p_unit_vec2D(0::float64);
	}
