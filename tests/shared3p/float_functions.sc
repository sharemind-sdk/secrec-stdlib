...
void test_inv(T data){
    {
        ...
        pd_shared3p T[[1]] result = inv(vec);
        pd_shared3p T[[2]] mat (0,0);
        pd_shared3p T[[2]] result2 = inv(mat);
        pd_shared3p T[[2]] mat2 (2,0);
        pd_shared3p T[[2]] result3 = inv(mat2);
        pd_shared3p T[[2]] mat3 (2,0);
        pd_shared3p T[[2]] result4 = inv(mat3);
    }
...
void test_sqrt(T data){
    {
        pd_shared3p T[[1]] vec (0);
        pd_shared3p T[[1]] result = sqrt(vec);
        pd_shared3p T[[2]] mat (0,0);
        pd_shared3p T[[2]] result2 = sqrt(mat);
        pd_shared3p T[[2]] mat2 (2,0);
        pd_shared3p T[[2]] result3 = sqrt(mat2);
        pd_shared3p T[[2]] mat3 (2,0);
        pd_shared3p T[[2]] result4 = sqrt(mat3);
    }
...
void test_sin(T data){
    {
        pd_shared3p T[[1]] vec (0);
        pd_shared3p T[[1]] result = sin(vec);
        pd_shared3p T[[2]] mat (0,0);
        pd_shared3p T[[2]] result2 = sin(mat);
        pd_shared3p T[[2]] mat2 (2,0);
        pd_shared3p T[[2]] result3 = sin(mat2);
        pd_shared3p T[[2]] mat3 (2,0);
        pd_shared3p T[[2]] result4 = sin(mat3);
    }
    pd_shared3p T temp = 2;
...
void test_ln(T data){
    {
        pd_shared3p T[[1]] vec (0);
        pd_shared3p T[[1]] result = ln(vec);
        pd_shared3p T[[2]] mat (0,0);
        pd_shared3p T[[2]] result2 = ln(mat);
        pd_shared3p T[[2]] mat2 (2,0);
        pd_shared3p T[[2]] result3 = ln(mat2);
        pd_shared3p T[[2]] mat3 (2,0);
        pd_shared3p T[[2]] result4 = ln(mat3);
    }
    pd_shared3p T temp = 2;
...
void test_exp(T data){
    {
        pd_shared3p T[[1]] vec (0);
        pd_shared3p T[[1]] result = exp(vec);
        pd_shared3p T[[2]] mat (0,0);
        pd_shared3p T[[2]] result2 = exp(mat);
        pd_shared3p T[[2]] mat2 (2,0);
        pd_shared3p T[[2]] result3 = exp(mat2);
        pd_shared3p T[[2]] mat3 (2,0);
        pd_shared3p T[[2]] result4 = exp(mat3);
    }
...
void test_erf(T data){
    {
        pd_shared3p T[[1]] vec (0);
        pd_shared3p T[[1]] result = erf(vec);
        pd_shared3p T[[2]] mat (0,0);
        pd_shared3p T[[2]] result2 = erf(mat);
        pd_shared3p T[[2]] mat2 (2,0);
        pd_shared3p T[[2]] result3 = erf(mat2);
        pd_shared3p T[[2]] mat3 (2,0);
        pd_shared3p T[[2]] result4 = erf(mat3);
    }
    pd_shared3p T temp = 4.730296322569438;
