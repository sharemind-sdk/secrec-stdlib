...
void main(){
	...
	{
		float32 pub = 0.0;
		pd_shared3p float32 priv = pub;
	}
	{
		float64 pub = 0.0;
		pd_shared3p float64 priv = pub;
	}
	print("TEST 0b: PRIVATE -> PUBLIC for Float32/64");
	{
		pd_shared3p float32 priv = 0.0;
		float32 pub = declassify(priv);
	}
	{
		pd_shared3p float64 priv = 0.0;
 	...
 	print("TEST 10: PUBLIC -> PRIVATE for Float32/64 vectors");
	{
		...
		pd_shared3p float32[[1]] priv = pub;
	}
	{
		float64[[1]] pub (15)= 0.0;
		pd_shared3p float64[[1]] priv = pub;
	}
	print("TEST 11: PRIVATE -> PUBLIC for Float32/64 vectors");
	{
		pd_shared3p float32[[1]] priv (15)= 0.0;
		float32[[1]] pub = declassify(priv);
	}
	{
		pd_shared3p float64[[1]] priv (15)= 0.0;
