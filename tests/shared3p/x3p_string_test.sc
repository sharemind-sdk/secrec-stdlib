...
void main(){
	...
	print("TEST 3: Count zeroes function");
	{
		{
			pd_shared3p xor_uint8[[1]] str (0);
			pd_shared3p uint result = countZeroes(str);
		}
	...
	print("TEST 4: is string empty function");
	{
		{
			pd_shared3p xor_uint8[[1]] str (0);
			pd_shared3p bool result = bl_strIsEmpty(str);
		}
		pd_shared3p xor_uint8[[1]] str (15) = 0;
	...
	print("TEST 6: String trimming function");
	{
		{
			pd_shared3p xor_uint8[[1]] str (0);
			pd_shared3p xor_uint8[[1]] length = bl_strTrim(str);
		}
	...
	print("TEST 7: 2 string are equal function");
	{
		{
			pd_shared3p xor_uint8[[1]] str (0);
			pd_shared3p xor_uint8[[1]] str2 (0);
			pd_shared3p bool result = bl_strEquals(str,str2);
		}
		pd_shared3p xor_uint8[[1]] str (43) = {84,104,101,32,113,117,105,99,107,32,98,114,111,119,110,32,102,111,120,32,106,117,109,112,115,32,111,118,101,114,32,116,104,101,32,108,97,122,121,32,100,111,103};
	...
	{
		{
			pd_shared3p bool[[1]] arr (0);
			pd_shared3p uint[[1]] result = findSortingPermutation(arr);
		}
	...
	print("TEST 10: String zero extend function");
	{
		{
			pd_shared3p xor_uint8[[1]] str (0);
			pd_shared3p xor_uint8[[1]] result = zeroExtend(str,5::uint);
		}
	...
	print("TEST 11: string alphabetizing function");
	{
		{
			pd_shared3p xor_uint8[[1]] vec (0);
			pd_shared3p xor_uint8[[1]] vec2 (0);
			pd_shared3p bool result = bl_strIsLessThan(vec,vec2);
		}
	...
	{
		{
			pd_shared3p xor_uint8[[1]] vec (0);
			pd_shared3p xor_uint8[[1]] vec2 (0);
			pd_shared3p bool result = bl_strContains(vec,vec2);
		}
	...
	{
		{
			pd_shared3p xor_uint8[[1]] vec (0);
			pd_shared3p xor_uint8[[1]] vec2 (0);
			pd_shared3p uint result = bl_strIndexOf(vec,vec2);
		}
		string str = "The quick brown fox jumps over the lazy dog";
		pd_shared3p xor_uint8[[1]] vec = bl_str(str);
	...
	{
		{
			pd_shared3p xor_uint8[[1]] vec (0);
			pd_shared3p xor_uint8[[1]] vec2 (0);
			pd_shared3p uint result = bl_strHamming(vec,vec2);
		}
		string str = "this is a test";
		pd_shared3p xor_uint8[[1]] vec = bl_str(str);
	...
	{
		{
			pd_shared3p xor_uint8[[1]] str (0);
			pd_shared3p xor_uint8[[1]] str2 (0);
			pd_shared3p bool result = kl_strEquals(str,str2);
		}
		pd_shared3p xor_uint8[[1]] str (43) = {84,104,101,32,113,117,105,99,107,32,98,114,111,119,110,32,102,111,120,32,106,117,109,112,115,32,111,118,101,114,32,116,104,101,32,108,97,122,121,32,100,111,103};
		pd_shared3p xor_uint8[[1]] str2 (43) = {84,104,101,32,113,117,105,99,107,32,98,114,111,119,110,32,102,111,120,32,106,117,109,112,115,32,111,118,101,114,32,116,104,101,32,108,97,122,121,32,100,111,103};
	...
	{
		{
			pd_shared3p xor_uint8[[1]] vec (0);
			pd_shared3p xor_uint8[[1]] vec2 (0);
			pd_shared3p bool result = kl_strIsLessThan(vec,vec2);
		}
		string str = "This is a test";
		string str2 = "This is also a test";
	...
	{
		{
			pd_shared3p xor_uint8[[1]] vec (0);
			pd_shared3p xor_uint8[[1]] vec2 (0);
			pd_shared3p xor_uint8[[1]] result = kl_strCat(vec,vec2);
		}
		pd_shared3p xor_uint8[[1]] str (21) = {84,104,101,32,113,117,105,99,107,32,98,114,111,119,110,32,102,111,120,32,106};
		pd_shared3p xor_uint8[[1]] str2 (22) = {117,109,112,115,32,111,118,101,114,32,116,104,101,32,108,97,122,121,32,100,111,103};
		pd_shared3p xor_uint8[[1]] control (43) = {84,104,101,32,113,117,105,99,107,32,98,114,111,119,110,32,102,111,120,32,106,117,109,112,115,32,111,118,101,114,32,116,104,101,32,108,97,122,121,32,100,111,103};
	...
	{
		{
			pd_shared3p xor_uint8[[1]] vec (0);
			pd_shared3p xor_uint8[[1]] vec2 (0);
			pd_shared3p bool result = kl_strContains(vec,vec2);
		}
		string str = "The quick brown fox jumps over the lazy dog";
		pd_shared3p xor_uint8[[1]] vec = kl_str(str);
		string sub_str = "k brown f";
