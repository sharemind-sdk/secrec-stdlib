...
void main(){
	...
	{
		print("float32");
		pd_shared3p float32 a = 15; pd_shared3p float32 b = 174; pd_shared3p float32 c = a+b;
		if(declassify(c) == 189){Success();}else{Failure("Expected 189",c);}
	}
	{
		print("float64");
		pd_shared3p float64 a = 175; pd_shared3p float64 b = 45876; pd_shared3p float64 c = a+b;
		if(declassify(c) == 46051){Success();}else{Failure("Expected 46051",c);}
	}
	print("TEST 3: Addition with one private one public value");
	{
		print("float32");
		pd_shared3p float32 a = 15; float32 b = 174; pd_shared3p float32 c = a+b;
		if(declassify(c) == 189){Success();}else{Failure("Expected 189",c);}
	}
	{
		print("float64");
		pd_shared3p float64 a = 175; float64 b = 45876; pd_shared3p float64 c = a+b;
		if(declassify(c) == 46051){Success();}else{Failure("Expected 46051",c);}
	}
	print("TEST 4: Addition with one private one public value(2)");
	{
		print("float32");
		pd_shared3p float32 a = 15; float32 b = 174; pd_shared3p float32 c = b+a;
		if(declassify(c) == 189){Success();}else{Failure("Expected 189",c);}
	}
	{
		print("float64");
		pd_shared3p float64 a = 175; float64 b = 45876; pd_shared3p float64 c = b+a;
		if(declassify(c) == 46051){Success();}else{Failure("Expected 46051",c);}
	}
	...
	{
		print("float32");
		pd_shared3p float32 a = 15; pd_shared3p float32 b = 174; pd_shared3p float32 c = b-a;
		if(declassify(c) == 159){Success();}else{Failure("Expected 159",c);}
	}
	{
		print("float64");
		pd_shared3p float64 a = 175; pd_shared3p float64 b = 45876; pd_shared3p float64 c = b-a;
	...
	{
		print("float32");
		pd_shared3p float32 a = 174; float32 b = 15; pd_shared3p float32 c = a-b;
		if(declassify(c) == 159){Success();}else{Failure("Expected 159",c);}
	}
	{
		print("float64");
		pd_shared3p float64 a = 45876; float64 b = 175; pd_shared3p float64 c = a-b;
		if(declassify(c) == 45701){Success();}else{Failure("Expected 45701",c);}
	}
	...
	{
		print("float32");
		pd_shared3p float32 a = 15; pd_shared3p float32 b = 12; pd_shared3p float32 c = a*b;
		if(declassify(c) == 180){Success();}else{Failure("Expected 180",c);}
	}
	{
		print("float64");
		pd_shared3p float64 a = 175; pd_shared3p float64 b = 139; pd_shared3p float64 c = a*b;
	...
	{
		print("float32");
		pd_shared3p float32 a = 15; float32 b = 12; pd_shared3p float32 c = a*b;
		if(declassify(c) == 180){Success();}else{Failure("Expected 180",c);}
	}
	{
		print("float64");
		pd_shared3p float64 a = 175; float64 b = 139; pd_shared3p float64 c = a*b;
		if(declassify(c) == 24325){Success();}else{Failure("Expected 24325",c);}
	}
	print("TEST 14: Multiplication with one private one public value(2)");
	{
		print("float32");
		pd_shared3p float32 a = 15; float32 b = 12; pd_shared3p float32 c = b*a;
		if(declassify(c) == 180){Success();}else{Failure("Expected 180",c);}
	}
	{
		print("float64");
		pd_shared3p float64 a = 175; float64 b = 139; pd_shared3p float64 c = b*a;
		if(declassify(c) == 24325){Success();}else{Failure("Expected 24325",c);}
	}
	...
	{
		print("float64");
		pd_shared3p float64 a = 180; pd_shared3p float64 b = 45900; pd_shared3p float64 c = b/a;
	...
	{
		print("float64");
		pd_shared3p float64 a = 180; float64 b = 45900; pd_shared3p float64 c = b/a;
		if(declassify(c) == 255){Success();}else{Failure("Expected 255",c);}
	}
	print("TEST 19: Division with one private one public value(2)");
	{
		print("float32");
		pd_shared3p float32 a = 180; float32 b = 15; pd_shared3p float32 c = a/b;
		if(declassify(c) == 12){Success();}else{Failure("Expected 12",c);}
	}
	{
		print("float64");
		pd_shared3p float64 a = 45900; float64 b = 180; pd_shared3p float64 c = a/b;
		if(declassify(c) == 255){Success();}else{Failure("Expected 255",c);}
	}
	...
	{
		print("float32");
		float32 a = 2398; pd_shared3p float32 b = 0;pd_shared3p float32 c = b/a;
		if(declassify(c) == 0){Success();}else{Failure("Expected 0",c);}
	}
	{
		print("float64");
		float64 a = 9083275; pd_shared3p float64 b = 0;pd_shared3p float64 c = b/a;
		if(declassify(c) == 0){Success();}else{Failure("Expected 0",c);}
	}
	...
	{
		print("float32");
		pd_shared3p float32 a = 645; pd_shared3p float32 b = 40; pd_shared3p float32 c = a/b;
		if(declassify(c) == 16.125){Success();}else{Failure("Expected 16.125",c);}
	}
	{
		print("float64");
		pd_shared3p float64 a = 645; pd_shared3p float64 b = 40; pd_shared3p float64 c = a/b;
		if(declassify(c) == 16.125){Success();}else{Failure("Expected 16.125",c);}
	}
