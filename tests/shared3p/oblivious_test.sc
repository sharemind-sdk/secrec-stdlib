...
void choice_test1_xor(D T data){
	pd_shared3p bool[[2]] cond (10,10) = true;
	pd_shared3p T[[2]] mat (10,10);
	pd_shared3p T[[2]] mat2 (10,10);
	mat = randomize(mat); mat2 = randomize(mat2);
	pd_shared3p T[[2]] mat3 = choose(cond,mat,mat2);
...
void choice_test2(T data){
	{
		pd_shared3p bool[[2]] cond (0,0);
		pd_shared3p T[[2]] mat (0,0);
		pd_shared3p T[[2]] mat2 (0,0);
		pd_shared3p T[[2]] mat3 = choose(cond,mat,mat2);
		pd_shared3p bool[[2]] cond2 (0,2);
		pd_shared3p T[[2]] mat4 (0,2);
		pd_shared3p T[[2]] mat5 (0,2);
		mat3 = choose(cond2,mat4,mat5);
		pd_shared3p bool[[2]] cond3 (2,0);
		pd_shared3p T[[2]] mat6 (2,0);
		pd_shared3p T[[2]] mat7 (2,0);
	...
	bool result = true;
	uint column;
	pd_shared3p bool[[2]] cond (6,6);
	pd_shared3p T[[2]] mat (6,6);
	pd_shared3p T[[2]] mat2 (6,6);
...
void vector_lookup_test(T data){
	{
		...
		pd_shared3p T scalar = vectorLookup(vec,index);
	}
	bool result = true;
...
void matrix_row_lookup(T data){
	...
	\todo matrixLookupRow fails when given an empty vector
	{
		pd_shared3p T[[2]] mat (0,0);
		pd_shared3p uint index = 0;
		pd_shared3p T[[1]] row = matrixLookupRow(mat,index);
