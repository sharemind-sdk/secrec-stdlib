...
bool variance_test(T data, G data2) {
	...
	pd_shared3p G var = variance(a);
	
	G x = (abs(declassify(var) - 8.41818181818182))/8.4182;
...
bool variance_test_filter(T data, G data2) {
	...
	pd_shared3p G var = variance(a, mask);	

	G x = (abs(declassify(var) - 8.94444444444444))/8.944444;
