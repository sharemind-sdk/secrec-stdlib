...
void test_any(){
	{
		pd_shared3p bool[[1]] vec (0);
		pd_shared3p bool result = any(vec);
	}
	bool result = true;
...
void test_all(){
	{
		pd_shared3p bool[[1]] vec (0);
		pd_shared3p bool result = all(vec);
	}
	bool result = true;
	pd_shared3p bool[[1]] vec (6) = {true,false,true,true,false,false};
...
void test_min3(T data){
	{
		...
		pd_shared3p T[[1]] result = min(vec,vec2); 
		pd_shared3p T[[2]] mat (0,0);
		pd_shared3p T[[2]] mat2 (0,0);
		pd_shared3p T[[2]] result2 = min(mat,mat2); 
