...
void main(){
	...
	{
		print("uint8");
		pd_shared3p uint8[[1]] a (15)= 15; pd_shared3p uint8[[1]] b (15)= 174; pd_shared3p uint8[[1]] c = a+b;
		if(all(declassify(c) == 189)){Success();}else{Failure("Expected 189");}
	}
	{
		print("uint16");
		pd_shared3p uint16[[1]] a (15)= 175; pd_shared3p uint16[[1]] b (15)= 45876; pd_shared3p uint16[[1]] c = a+b;
		if(all(declassify(c) == 46051)){Success();}else{Failure("Expected 46051");}
	}
	{
		print("uint32");
		pd_shared3p uint32[[1]] a (15)= 2398; pd_shared3p uint32[[1]] b (15)= 21798357; pd_shared3p uint32[[1]] c = a+b;
		if(all(declassify(c) == 21800755)){Success();}else{Failure("Expected 21800755");}
	}
	{
		print("uint");
		pd_shared3p uint[[1]] a (15)= 2578953; pd_shared3p uint[[1]] b (15)= 1872698523698; pd_shared3p uint[[1]] c = a+b;
		if(all(declassify(c) == 1872701102651)){Success();}else{Failure("Expected 1872701102651");}
	}
	{
		print("int8");
		pd_shared3p int8[[1]] a (15)= -25; pd_shared3p int8[[1]] b (15)= 50; pd_shared3p int8[[1]] c = a+b;
		if(all(declassify(c) == 25)){Success();}else{Failure("Expected 25");}
	}
	{
		print("int16");
		pd_shared3p int16[[1]] a (15)= -2264; pd_shared3p int16[[1]] b (15)= 22468; pd_shared3p int16[[1]] c = a+b;
		if(all(declassify(c) == 20204)){Success();}else{Failure("Expected 20204");}
	}
	{
		print("int32");
		pd_shared3p int32[[1]] a (15)= -12549; pd_shared3p int32[[1]] b (15)= 21485747; pd_shared3p int32[[1]] c = a+b;
		if(all(declassify(c) == 21473198)){Success();}else{Failure("Expected 21800755");}
	}
	{
		print("int");
		pd_shared3p int[[1]] a (15)= 2954; pd_shared3p int[[1]] b (15)= 93214654775807; pd_shared3p int[[1]] c = a+b;
	...
	{
		print("uint8");
		pd_shared3p uint8[[1]] a (15)= 15; uint8[[1]] b (15)= 174; pd_shared3p uint8[[1]] c = a+b;
		if(all(declassify(c) == 189)){Success();}else{Failure("Expected 189");}
	}
	{
		print("uint16");
		pd_shared3p uint16[[1]] a (15)= 175; uint16[[1]] b (15)= 45876; pd_shared3p uint16[[1]] c = a+b;
		if(all(declassify(c) == 46051)){Success();}else{Failure("Expected 46051");}
	}
	{
		print("uint32");
		pd_shared3p uint32[[1]] a (15)= 2398; uint32[[1]] b (15)= 21798357; pd_shared3p uint32[[1]] c = a+b;
		if(all(declassify(c) == 21800755)){Success();}else{Failure("Expected 21800755");}
	}
	{
		print("uint");
		pd_shared3p uint[[1]] a (15)= 2578953; uint[[1]] b (15)= 1872698523698; pd_shared3p uint[[1]] c = a+b;
		if(all(declassify(c) == 1872701102651)){Success();}else{Failure("Expected 1872701102651");}
	}
	{
		print("int8");
		pd_shared3p int8[[1]] a (15)= -25; int8[[1]] b (15)= 50; pd_shared3p int8[[1]] c = a+b;
		if(all(declassify(c) == 25)){Success();}else{Failure("Expected 25");}
	}
	{
		print("int16");
		pd_shared3p int16[[1]] a (15)= -2264; int16[[1]] b (15)= 22468; pd_shared3p int16[[1]] c = a+b;
		if(all(declassify(c) == 20204)){Success();}else{Failure("Expected 20204");}
	}
	{
		print("int32");
		pd_shared3p int32[[1]] a (15)= -12549; int32[[1]] b (15)= 21485747; pd_shared3p int32[[1]] c = a+b;
		if(all(declassify(c) == 21473198)){Success();}else{Failure("Expected 21800755");}
	}
	{
		print("int");
		pd_shared3p int[[1]] a (15)= 2954; int[[1]] b (15)= 93214654775807; pd_shared3p int[[1]] c = a+b;
		if(all(declassify(c) == 93214654778761)){Success();}else{Failure("Expected 93214654778761");}
	}
	...
	{
		print("uint32");
		pd_shared3p uint32[[1]] a (15)= 2398; uint32[[1]] b (15)= 21798357; pd_shared3p uint32[[1]] c = b+a;
		if(all(declassify(c) == 21800755)){Success();}else{Failure("Expected 21800755");}
	}
	{
		print("uint");
	...
	{
		print("int8");
		pd_shared3p int8[[1]] a (15)= -25; int8[[1]] b (15)= 50; pd_shared3p int8[[1]] c = b+a;
		if(all(declassify(c) == 25)){Success();}else{Failure("Expected 25");}
	}
	{
		print("int16");
		pd_shared3p int16[[1]] a (15)= -2264; int16[[1]] b (15)= 22468; pd_shared3p int16[[1]] c = b+a;
		if(all(declassify(c) == 20204)){Success();}else{Failure("Expected 20204");}
	}
	{
		print("int32");
		pd_shared3p int32[[1]] a (15)= -12549; int32[[1]] b (15)= 21485747; pd_shared3p int32[[1]] c = b+a;
		if(all(declassify(c) == 21473198)){Success();}else{Failure("Expected 21800755");}
	}
	{
		print("int");
		pd_shared3p int[[1]] a (15)= 2954; int[[1]] b (15)= 93214654775807; pd_shared3p int[[1]] c = b+a;
		if(all(declassify(c) == 93214654778761)){Success();}else{Failure("Expected 93214654778761");}
	}
	print("TEST 6: Addition with two private vectors modulo (type_MAX + 1)");
	{
		print("uint8");
		pd_shared3p uint8[[1]] a (15)= 1; pd_shared3p uint8[[1]] b (15)= UINT8_MAX; pd_shared3p uint8[[1]] c = a+b;
		if(all(declassify(c) == 0)){Success();}else{Failure("Expected 0");}
	}
	{
		print("uint16");
		pd_shared3p uint16[[1]] a (15)= 1; pd_shared3p uint16[[1]] b (15)= UINT16_MAX; pd_shared3p uint16[[1]] c = a+b;
		if(all(declassify(c) == 0)){Success();}else{Failure("Expected 0");}
	}
	{
		print("uint32");
		pd_shared3p uint32[[1]] a (15)= 1; pd_shared3p uint32[[1]] b (15)= UINT32_MAX; pd_shared3p uint32[[1]] c = a+b;
		if(all(declassify(c) == 0)){Success();}else{Failure("Expected 0");}
	}
	{
		print("uint");
		pd_shared3p uint[[1]] a (15)= 1; pd_shared3p uint[[1]] b (15)= UINT64_MAX; pd_shared3p uint[[1]] c = a+b;
		if(all(declassify(c) == 0)){Success();}else{Failure("Expected 0");}
	}
	{
		print("int8");
		pd_shared3p int8[[1]] a (15)= 1; pd_shared3p int8[[1]] b (15)= INT8_MAX; pd_shared3p int8[[1]] c = a+b;
		if(all(declassify(c) == INT8_MIN)){Success();}else{Failure("Expected -128");}
	}
	{
		print("int16");
		pd_shared3p int16[[1]] a (15)= 1; pd_shared3p int16[[1]] b (15)= INT16_MAX; pd_shared3p int16[[1]] c = a+b;
		if(all(declassify(c) == INT16_MIN)){Success();}else{Failure("Expected -32768");}
	}
	{
		print("int32");
		pd_shared3p int32[[1]] a (15)= 1; pd_shared3p int32[[1]] b (15)= INT32_MAX; pd_shared3p int32[[1]] c = a+b;
		if(all(declassify(c) == INT32_MIN)){Success();}else{Failure("Expected -2147483648");}
	}
	{
		print("int");
		pd_shared3p int[[1]] a (15)= 1; pd_shared3p int[[1]] b (15)= INT64_MAX; pd_shared3p int[[1]] c = a+b;
	...
	{
		print("uint8");
		pd_shared3p uint8[[1]] a (15)= 15; pd_shared3p uint8[[1]] b (15)= UINT8_MAX; pd_shared3p uint8[[1]] c = a+b+1;
		if(all(declassify(c) == declassify(a))){Success();}else{Failure("Expected 15");}
	}
	{
		print("uint16");
		pd_shared3p uint16[[1]] a (15)= 175; pd_shared3p uint16[[1]] b (15)= UINT16_MAX; pd_shared3p uint16[[1]] c = a+b+1;
		if(all(declassify(c) == declassify(a))){Success();}else{Failure("Expected 175");}
	}
	{
		print("uint32");
		pd_shared3p uint32[[1]] a (15)= 2398; pd_shared3p uint32[[1]] b (15)= UINT32_MAX; pd_shared3p uint32[[1]] c = a+b+1;
		if(all(declassify(c) == declassify(a))){Success();}else{Failure("Expected 2398");}
	}
	{
		print("uint");
		pd_shared3p uint[[1]] a (15)= 2578953; pd_shared3p uint[[1]] b (15)= UINT64_MAX; pd_shared3p uint[[1]] c = a+b+1;
	...
	{
		print("uint32");
		pd_shared3p uint32[[1]] a (15)= 2398; pd_shared3p uint32[[1]] b (15) = 21798357; pd_shared3p uint32[[1]] c = b-a;
	...
	{
		print("int8");
		pd_shared3p int8[[1]] a (15)= 25; pd_shared3p int8[[1]] b (15)= 50; pd_shared3p int8[[1]] c = b-a;
		if(all(declassify(c) == 25)){Success();}else{Failure("Expected 25");}
	}
	{
		print("int16");
		pd_shared3p int16[[1]] a (15)= 42264; pd_shared3p int16[[1]] b (15)= 22468; pd_shared3p int16[[1]] c = b-a;
		if(all(declassify(c) == -19796)){Success();}else{Failure("Expected -19796");}
	}
	{
		print("int32");
		pd_shared3p int32[[1]] a (15)= 12549; pd_shared3p int32[[1]] b (15)= 21485747; pd_shared3p int32[[1]] c = b-a;
		if(all(declassify(c) == 21473198)){Success();}else{Failure("Expected 21473198");}
	}
	{
		print("int");
		pd_shared3p int[[1]] a (15)= 2954; pd_shared3p int[[1]] b (15) = 93214654775807; pd_shared3p int[[1]] c = b-a;
	...
	{
		print("int16");
		pd_shared3p int16[[1]] a (15)= 42264; int16[[1]] b (15)= 22468; pd_shared3p int16[[1]] c = b-a;
		if(all(declassify(c) == -19796)){Success();}else{Failure("Expected -19796");}
	}
	{
		print("int32");
	...
	{
		print("uint8");
		pd_shared3p uint8[[1]] a (15)= 174; uint8[[1]] b (15)= 15; pd_shared3p uint8[[1]] c = a-b;
		if(all(declassify(c) == 159)){Success();}else{Failure("Expected 159");}
	}
	{
		print("uint16");
		pd_shared3p uint16[[1]] a (15)= 45876; uint16[[1]] b (15)= 175; pd_shared3p uint16[[1]] c = a-b;
		if(all(declassify(c) == 45701)){Success();}else{Failure("Expected 45701");}
	}
	{
		print("uint32");
		pd_shared3p uint32[[1]] a (15)= 21798357; uint32[[1]] b (15)= 2398; pd_shared3p uint32[[1]]c = a-b;
		if(all(declassify(c) == 21795959)){Success();}else{Failure("Expected 21795959");}
	}
	{
		print("uint");
		pd_shared3p uint[[1]] a (15)= 1872698523698; uint[[1]] b (15)= 2578953; pd_shared3p uint[[1]]c = a-b;
		if(all(declassify(c) == 1872695944745)){Success();}else{Failure("Expected 1872695944745");}
	}
	{
		print("int8");
		pd_shared3p int8[[1]] a (15)= 50; int8[[1]] b (15)= 25; pd_shared3p int8[[1]] c = a-b;
		if(all(declassify(c) == 25)){Success();}else{Failure("Expected 25");}
	}
	{
		print("int16");
		pd_shared3p int16[[1]] a (15)= 22468; int16[[1]] b (15)= 42264; pd_shared3p int16[[1]] c = a-b;
		if(all(declassify(c) == -19796)){Success();}else{Failure("Expected -19796");}
	}
	{
		print("int32");
		pd_shared3p int32[[1]] a (15)= 21485747; int32[[1]] b (15)=12549; pd_shared3p int32[[1]] c = a-b;
		if(all(declassify(c) == 21473198)){Success();}else{Failure("Expected 21473198");}
	}
	{
		print("int");
		pd_shared3p int[[1]] a (15)= 93214654775807; int[[1]] b (15)= 2954; pd_shared3p int[[1]] c = a-b;
		if(all(declassify(c) == 93214654772853)){Success();}else{Failure("Expected 93214654772853");}
	}
	print("TEST 14: Subtraction with two private vectors modulo (type_MIN - 1)");
	{
		print("uint8");
		pd_shared3p uint8[[1]] a (15)= 1; pd_shared3p uint8[[1]] b (15)= 0; pd_shared3p uint8[[1]] c = b-a;
		if(all(declassify(c) == UINT8_MAX)){Success();}else{Failure("Expected 255");}
	}
	{
		print("uint16");
		pd_shared3p uint16[[1]] a (15)= 1; pd_shared3p uint16[[1]] b (15)= 0; pd_shared3p uint16[[1]] c = b-a;
		if(all(declassify(c) == UINT16_MAX)){Success();}else{Failure("Expected 65535");}
	}
	{
		print("uint32");
		pd_shared3p uint32[[1]] a (15)= 1; pd_shared3p uint32[[1]] b (15)= 0; pd_shared3p uint32[[1]] c = b-a;
		if(all(declassify(c) == UINT32_MAX)){Success();}else{Failure("Expected 4294967295");}
	}
	{
		print("uint");
		pd_shared3p uint[[1]] a (15)= 1; pd_shared3p uint[[1]] b (15)= 0; pd_shared3p uint[[1]] c = b-a;
		if(all(declassify(c) == UINT64_MAX)){Success();}else{Failure("Expected 18446744073709551615");}
	}
	{
		print("int8");
		pd_shared3p int8[[1]] a (15)= 1; pd_shared3p int8[[1]] b (15)= INT8_MIN; pd_shared3p int8[[1]] c = b-a;
		if(all(declassify(c) == INT8_MAX)){Success();}else{Failure("Expected 127");}
	}
	{
		print("int16");
		pd_shared3p int16[[1]] a (15)= 1; pd_shared3p int16[[1]] b (15)= INT16_MIN; pd_shared3p int16[[1]] c = b-a;
		if(all(declassify(c) == INT16_MAX)){Success();}else{Failure("Expected 32767");}
	}
	{
		print("int32");
		pd_shared3p int32[[1]] a (15)= 1; pd_shared3p int32[[1]] b (15)= INT32_MIN; pd_shared3p int32[[1]] c = b-a;
		if(all(declassify(c) == INT32_MAX)){Success();}else{Failure("Expected 2147483647");}
	}
	{
		print("int");
		pd_shared3p int[[1]] a = 1; pd_shared3p int[[1]] b = INT64_MIN; pd_shared3p int[[1]] c = b-a;
	...
	{
		print("uint8");
		pd_shared3p uint8[[1]] a (15)= 15; pd_shared3p uint8[[1]] b (15)= 12; pd_shared3p uint8[[1]] c = a*b;
		if(all(declassify(c) == 180)){Success();}else{Failure("Expected 180");}
	}
	{
		print("uint16");
		pd_shared3p uint16[[1]] a (15)= 175; pd_shared3p uint16[[1]] b (15)= 139; pd_shared3p uint16[[1]] c = a*b;
		if(all(declassify(c) == 24325)){Success();}else{Failure("Expected 24325");}
	}
	{
		print("uint32");
		pd_shared3p uint32[[1]] a (15)= 2398; pd_shared3p uint32[[1]] b (15)= 4051; pd_shared3p uint32[[1]] c = a*b;
		if(all(declassify(c) == 9714298)){Success();}else{Failure("Expected 9714298");}
	}
	{
		print("uint");
		pd_shared3p uint[[1]] a (15)= 248924; pd_shared3p uint[[1]] b (15)= 48265; pd_shared3p uint[[1]] c = a*b;
		if(all(declassify(c) == 12014316860)){Success();}else{Failure("Expected 12014316860");}
	}
	{
		print("int8");
		pd_shared3p int8[[1]] a (15)= 25; pd_shared3p int8[[1]] b (15)= -4; pd_shared3p int8[[1]] c = a*b;
		if(all(declassify(c) == -100)){Success();}else{Failure("Expected -100");}
	}
	{
		print("int16");
		pd_shared3p int16[[1]] a (15)= 175; pd_shared3p int16[[1]] b (15)= 139; pd_shared3p int16[[1]] c = a*b;
		if(all(declassify(c) == 24325)){Success();}else{Failure("Expected 24325");}
	}
	{
		print("int32");
		pd_shared3p int32[[1]] a (15)= -2398; pd_shared3p int32[[1]] b (15)= 4051; pd_shared3p int32[[1]] c = a*b;
		if(all(declassify(c) == -9714298)){Success();}else{Failure("Expected -9714298");}
	}
	{
		print("int");
		pd_shared3p int[[1]] a (15)= 248924; pd_shared3p int[[1]] b (15)= 48265; pd_shared3p int[[1]] c = a*b;
		if(all(declassify(c) == 12014316860)){Success();}else{Failure("Expected 12014316860");}
	}
	print("TEST 17: Multiplication with one private one public vector");
	{
		print("uint8");
		pd_shared3p uint8[[1]] a (15)= 15; uint8[[1]] b (15)= 12; pd_shared3p uint8[[1]] c = a*b;
		if(all(declassify(c) == 180)){Success();}else{Failure("Expected 180");}
	}
	{
		print("uint16");
		pd_shared3p uint16[[1]] a (15)= 175; uint16[[1]] b (15)= 139; pd_shared3p uint16[[1]] c = a*b;
		if(all(declassify(c) == 24325)){Success();}else{Failure("Expected 24325");}
	}
	{
		print("uint32");
		pd_shared3p uint32[[1]] a (15)= 2398; uint32[[1]] b (15)= 4051; pd_shared3p uint32[[1]] c = a*b;
		if(all(declassify(c) == 9714298)){Success();}else{Failure("Expected 9714298");}
	}
	{
		print("uint");
		pd_shared3p uint[[1]] a (15)= 248924; uint[[1]] b (15)= 48265; pd_shared3p uint[[1]] c = a*b;
		if(all(declassify(c) == 12014316860)){Success();}else{Failure("Expected 12014316860");}
	}
	{
		print("int8");
		pd_shared3p int8[[1]] a (15)= 25; int8[[1]] b (15)= -4; pd_shared3p int8[[1]] c = a*b;
		if(all(declassify(c) == -100)){Success();}else{Failure("Expected -100");}
	}
	{
		print("int16");
		pd_shared3p int16[[1]] a (15)= 175; int16[[1]] b (15)= 139; pd_shared3p int16[[1]] c = a*b;
		if(all(declassify(c) == 24325)){Success();}else{Failure("Expected 24325");}
	}
	{
		print("int32");
		pd_shared3p int32[[1]] a (15)= -2398; int32[[1]] b (15)= 4051; pd_shared3p int32[[1]] c = a*b;
		if(all(declassify(c) == -9714298)){Success();}else{Failure("Expected -9714298");}
	}
	{
		print("int");
		pd_shared3p int[[1]] a (15)= 248924; int[[1]] b (15)= 48265; pd_shared3p int[[1]] c = a*b;
		if(all(declassify(c) == 12014316860)){Success();}else{Failure("Expected 12014316860");}
	}
	print("TEST 18: Multiplication with one private one public value(2)");
	{
		print("uint8");
		pd_shared3p uint8[[1]] a (15)= 15; uint8[[1]] b (15)= 12; pd_shared3p uint8[[1]] c = b*a;
		if(all(declassify(c) == 180)){Success();}else{Failure("Expected 180");}
	}
	{
		print("uint16");
		pd_shared3p uint16[[1]] a (15)= 175; uint16[[1]] b (15)= 139; pd_shared3p uint16[[1]] c = b*a;
		if(all(declassify(c) == 24325)){Success();}else{Failure("Expected 24325");}
	}
	{
		print("uint32");
		pd_shared3p uint32[[1]] a (15)= 2398; uint32[[1]] b (15)= 4051; pd_shared3p uint32[[1]] c = b*a;
		if(all(declassify(c) == 9714298)){Success();}else{Failure("Expected 9714298");}
	}
	{
		print("uint");
		pd_shared3p uint[[1]] a (15)= 248924; uint[[1]] b (15)= 48265; pd_shared3p uint[[1]] c = b*a;
		if(all(declassify(c) == 12014316860)){Success();}else{Failure("Expected 12014316860");}
	}
	{
		print("int8");
		pd_shared3p int8[[1]] a (15)= 25; int8[[1]] b (15)= -4; pd_shared3p int8[[1]] c = b*a;
		if(all(declassify(c) == -100)){Success();}else{Failure("Expected -100");}
	}
	{
		print("int16");
		pd_shared3p int16[[1]] a (15)= 175; int16[[1]] b (15)= 139; pd_shared3p int16[[1]] c = b*a;
		if(all(declassify(c) == 24325)){Success();}else{Failure("Expected 24325");}
	}
	{
		print("int32");
		pd_shared3p int32[[1]] a (15)= -2398; int32[[1]] b (15)= 4051; pd_shared3p int32[[1]] c = b*a;
		if(all(declassify(c) == -9714298)){Success();}else{Failure("Expected -9714298");}
	}
	{
		print("int");
		pd_shared3p int[[1]] a (15)= 248924; int[[1]] b (15)= 48265; pd_shared3p int[[1]] c = b*a;
		if(all(declassify(c) == 12014316860)){Success();}else{Failure("Expected 12014316860");}
	}
	print("TEST 20: Multiplication with two private values modulo (type_MAX * 5)");
	{
		print("uint8");
		pd_shared3p uint8[[1]] a (15)= UINT8_MAX-1; pd_shared3p uint8[[1]] b (15)= 5; pd_shared3p uint8[[1]] c = a*b;
		if(all(declassify(c) == 246)){Success();}else{Failure("Expected 246");}
	}
	{
		print("uint16");
		pd_shared3p uint16[[1]] a (15)= UINT16_MAX-1; pd_shared3p uint16[[1]] b (15)= 5; pd_shared3p uint16[[1]] c = a*b;
		if(all(declassify(c) == 65526)){Success();}else{Failure("Expected 65526");}
	}
	{
		print("uint32");
		pd_shared3p uint32[[1]] a (15)= UINT32_MAX-1; pd_shared3p uint32[[1]] b (15)= 5; pd_shared3p uint32[[1]] c = a*b;
		if(all(declassify(c) == 4294967286)){Success();}else{Failure("Expected 4294967286");}
	}
	{
		print("uint");
		pd_shared3p uint[[1]] a (15)= UINT64_MAX-1; pd_shared3p uint[[1]] b (15)= 5; pd_shared3p uint[[1]] c = a*b;
		if(all(declassify(c) == 18446744073709551606)){Success();}else{Failure("Expected 18446744073709551606");}
	}
	{
		print("int8");
		pd_shared3p int8[[1]] a (15)= INT8_MAX-1; pd_shared3p int8[[1]] b (15)= 5; pd_shared3p int8[[1]] c = a*b;
		if(all(declassify(c) == 118)){Success();}else{Failure("Expected 118");}
	}
	{
		print("int16");
		pd_shared3p int16[[1]] a (15)= INT16_MAX-1; pd_shared3p int16[[1]] b (15)= 5; pd_shared3p int16[[1]] c = a*b;
		if(all(declassify(c) == 32758)){Success();}else{Failure("Expected 32758");}
	}
	{
		print("int32");
		pd_shared3p int32[[1]] a (15)= INT32_MAX-1; pd_shared3p int32[[1]] b (15)= 5; pd_shared3p int32[[1]] c = a*b;
		if(all(declassify(c) == 2147483638)){Success();}else{Failure("Expected 2147483638");}
	}
	{
		print("int");
		pd_shared3p int[[1]] a (15)= INT64_MAX-1; pd_shared3p int[[1]] b (15)= 5; pd_shared3p int[[1]] c = a*b;
	...
	****************************************************************************/
	...
	{
		print("uint32");
		pd_shared3p uint32[[1]] a (15)= 2398; uint32[[1]] b (15)= 0; pd_shared3p uint32[[1]] c = b/a;
		if(all(declassify(c) == 0)){Success();}else{Failure("Expected 0");}
	}
	{
		print("uint");
	...
	{
		print("uint32");
		pd_shared3p uint32[[1]] a (15)= UINT32_MAX; pd_shared3p uint32[[1]] b (15)= UINT32_MAX -1; pd_shared3p uint32[[1]] c = b/a;
		if(all(declassify(c) == 0)){Success();}else{Failure("Expected 0");}
	}
	{
		print("uint");
	...
	****************************************************************************/
	...
	}
	{
		...
		print("uint32");
		pd_shared3p uint32[[1]] b (15)= 2398; pd_shared3p uint32[[1]] a (15)= 21798357; pd_shared3p uint32[[1]] c = a%b;
	...
	}
	{
		...
		// other data types stop miners 2 and 3;
		print("uint32");
		pd_shared3p uint32[[1]] b (15)= 2398; uint32[[1]] a (15)= 21798357; pd_shared3p uint32[[1]] c = a%b;
		if(all(declassify(c) == 537)){Success();}else{Failure("Expected 537");}
	}
	{
		print("uint");
	...
	{
		print("uint8");
		pd_shared3p uint8[[1]] b (15)= 174; uint8[[1]] a (15)= 15; pd_shared3p uint8[[1]] c = b%a;
		if(all(declassify(c) == 9)){Success();}else{Failure("Expected 9");}
	}
	{
		print("uint16");
		pd_shared3p uint16[[1]] b (15)= 45876; uint16[[1]] a (15)= 175 ; pd_shared3p uint16[[1]] c = b%a;
		if(all(declassify(c) == 26)){Success();}else{Failure("Expected 26");}
	}
	{
		// unlike other data types, uint32 throws SHAREMIND_VM_PROCESS_GENERAL_SYSCALL_FAILURE
		// other data types stop miners 2 and 3;
		print("uint32");
		pd_shared3p uint32[[1]] b (15)= 21798357; uint32[[1]] a (15)= 2398 ; pd_shared3p uint32[[1]] c = b%a;
		if(all(declassify(c) == 537)){Success();}else{Failure("Expected 537");}
	}
	{
		print("uint");
		pd_shared3p uint[[1]] b (15)= 1872698523698; uint[[1]] a (15)= 2578953; pd_shared3p uint[[1]] c = b%a;
		if(all(declassify(c) == 2118560)){Success();}else{Failure("Expected 2118560");}
	}
	{
		print("int8");
	...
	}
	{
		...
		// other data types stop miners 2 and 3;
		print("uint32");
		pd_shared3p uint32[[1]] b (15)= 1; pd_shared3p uint32[[1]] a (15)= 0; pd_shared3p uint32[[1]] c = a%b;
		if(all(declassify(c) == 0)){Success();}else{Failure("Expected 0");}
	...
	{
		print("bool");
		pd_shared3p bool[[1]] a (15)= true;
		pd_shared3p bool[[1]] b (15)= false;
	...
	{
		print("uint8");
		pd_shared3p uint8[[1]] a (15)= 25;
		pd_shared3p uint8[[1]] b (15)= 26;
		if(all(declassify(a != b))){Success();}
		else{Failure("Boolean negation failed");}
	}
	{
		print("uint16");
		pd_shared3p uint16[[1]] a (15)= 25;
		pd_shared3p uint16[[1]] b (15)= 26;
		if(all(declassify(a != b))){Success();}
		else{Failure("Boolean negation failed");}
	}
	{
		print("uint32");
		pd_shared3p uint32[[1]] a (15)= 25;
		pd_shared3p uint32[[1]] b (15)= 26;
		if(all(declassify(a != b))){Success();}
		else{Failure("Boolean negation failed");}
	}
	{
		print("uint64");
		pd_shared3p uint64[[1]] a (15)= 25;
		pd_shared3p uint64[[1]] b (15)= 26;
		if(all(declassify(a != b))){Success();}
		else{Failure("Boolean negation failed");}
	}
	{
		print("int8");
		pd_shared3p int8[[1]] a (15)= 25;
		pd_shared3p int8[[1]] b (15)= 26;
		if(all(declassify(a != b))){Success();}
		else{Failure("Boolean negation failed");}
	}
	{
		print("int16");
		pd_shared3p int16[[1]] a (15)= 25;
		pd_shared3p int16[[1]] b (15)= 26;
		if(all(declassify(a != b))){Success();}
		else{Failure("Boolean negation failed");}
	}
	{
		print("int32");
		pd_shared3p int32[[1]] a (15)= 25;
		pd_shared3p int32[[1]] b (15)= 26;
		if(all(declassify(a != b))){Success();}
		else{Failure("Boolean negation failed");}
	}
	{
		print("int64/int");
		pd_shared3p int64[[1]] a (15)= 25;
		pd_shared3p int64[[1]] b (15)= 26;
		if(all(declassify(a != b))){Success();}
		else{Failure("Boolean negation failed");}
	}
	{
		print("xor_uint8");
		pd_shared3p xor_uint8[[1]] a (15)= 25;
		pd_shared3p xor_uint8[[1]] b (15)= 26;
		if(all(declassify(a != b))){Success();}
		else{Failure("Boolean negation failed");}
	}
	{
		print("xor_uint16");
		pd_shared3p xor_uint16[[1]] a (15)= 25;
		pd_shared3p xor_uint16[[1]] b (15)= 26;
		if(all(declassify(a != b))){Success();}
		else{Failure("Boolean negation failed");}
	}
	{
		print("xor_uint32");
		pd_shared3p xor_uint32[[1]] a (15)= 25;
		pd_shared3p xor_uint32[[1]] b (15)= 26;
		if(all(declassify(a != b))){Success();}
		else{Failure("Boolean negation failed");}
	}
	{
		print("xor_uint64");
		pd_shared3p xor_uint64[[1]] a (15)= 25;
		pd_shared3p xor_uint64[[1]] b (15)= 26;
		if(all(declassify(a != b))){Success();}
		else{Failure("Boolean negation failed");}
	}
